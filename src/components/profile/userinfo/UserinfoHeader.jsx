export default function UserinfoHeader() {
  return (
    <div className="bg-[url('@/assets/images/profile/headerbackground.jpg')] bg-center my-12 pl-4 md:pl-20 pr-2 md:pr-14 pt-6 md:pt-10 pb-3 text-white rounded-[6%] max-w-[1500px] m-auto">
