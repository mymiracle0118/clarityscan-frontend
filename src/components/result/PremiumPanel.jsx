...
const PremiumPanel = () => {
  return (
    <div className="bg-[url('/src/assets/images/result/bg1.png')] bg-cover bg-left text-white pt-7 pb-4 pl-7 pr-6 rounded-[30px] flex-none md:w-full xl:w-[calc(665/1920*100%)] 2xl:w-[calc(700/1920*100%)] 2xl:max-w-[600px]  mb-4 sm:mb-7 xl:mb-0 ">
