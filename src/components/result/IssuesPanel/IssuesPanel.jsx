...
const IssuesPanel = () => {
  const chartValues = [
    ...
    { label: "Low", y: 5, color: "#3087f8" },
    { label: "Informational", y: 2, color: "#fdd227" },
    { label: "Gas", y: 5, color: "#fb65c3" },
  ];
  const onclick = () => {
    ...
    <div className=" border-white border-4 rounded-[40px] px-2 py-6 2xl:px-7 xl:pl-10 2xl:pl-20 text-white bg-[#0A081D] xl:w-3/5 md:w-full">
      <div className="sm:flex justify-between md:gap-x-4 xl:gap-x-12">
        <div className="w-full lg:w-[600px]">
          ...
          <div className="mt-8 lg:pl-6 xl:pl-0">
        ...
        <div className="flex flex-col justify-between">
          {chartValues.map((item, i) => (
            <div
              key={i}
              className="mb-5 md:mb-10 last:mb-0 w-48 md:w-auto mx-auto"
            >
